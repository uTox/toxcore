...
typedef struct {
    ...
    struct {
        int (*status_callback)(void *object, int friend_id, int device_id, uint8_t status, void *userdata);
        void *status_callback_object;
        int status_callback_friend_id;
        int status_callback_device_id;

        int (*data_callback)(void *object, int friend_id, int device_id, const uint8_t *data, uint16_t length, void *userdata);
        void *data_callback_object;
        int data_callback_friend_id;
        int data_callback_device_id;

        int (*lossy_data_callback)(void *object, int friend_id, int device_id, const uint8_t *data, uint16_t length, void *userdata);
...
typedef struct Tox_Connections {
    ...
    int (*friend_request_callback)(void *object, const uint8_t *source_pubkey, const uint8_t *data, uint16_t len, void *userdata);
    void *friend_request_object;
 ...
 */
int send_friend_request_pkt(Tox_Connections *tox_conns, int toxconn_id, uint32_t nospam_num, const uint8_t *data, uint16_t length);
